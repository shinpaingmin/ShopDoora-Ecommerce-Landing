    ...
    <div className="grid grid-cols-auto-fit-100 gap-1">
        <div className="row-span-2 col-span-2">
            <div className="h-96 relative overflow-hidden">
                <img src="https://i0.wp.com/www.qssv.net/wp-content/uploads/2018/10/Revenger-X.png?fit=1598%2C837&ssl=1" alt=""
        ...
        <div className="row-span-2">
            <div className="h-96 relative overflow-hidden">
                <img src="https://www.houseofvape.co.za/wp-content/uploads/Revenger.png" alt=""
        ...
        <div className="grid grid-cols-1 grid-rows-2 gap-1 h-96">
            <div className="h-full w-full">
                <div className="relative overflow-hidden w-full h-full">
                    <img src="https://images.unsplash.com/photo-1594177914682-d408d96e458b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDEzfHx8ZW58MHx8fHx8&w=1000&q=80" alt=""
